...
- **全自动流程**：内置 ESP、轨道能级图、IRI/RDG/IGMH、Fukui/双描述符、空穴-电子/NTO、自旋密度及电子密度差/变形密度；自动完成计算、校验、Tachyon 绘图与结果整理。
...
- **电子密度差／变形密度**：按 Multiwfn 手册计算分子电子密度与同一几何下自由原子叠加密度之差，使用随软件提供的球对称原子波函数数据，以正负等值面显示电子积累与耗散区域。
