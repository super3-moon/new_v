...
ORIGINAL_SURFACE_STYLES = [
    ...
    },
    {
        ...
        "notes": "Original cyan/yellow translucent Glossy surface with the gray molecular skeleton shown by its reference image.",
    },
    {
        ...
        "sources": ["user-upload:param-pack"],
        "notes": "Original purple/gray translucent Glossy surface with the thin black skeleton shown by its reference image.",
    },
    {
